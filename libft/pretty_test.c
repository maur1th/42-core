...
// void		ft_putnbr_fd(int n, int fd);
	...
	assert("returned indentical to system", (int)dummy_ptr1, (int)dummy_ptr2);
	...
	memmove(dummy_str1 + 1, dummy_str1, STR_NORMAL_LEN);
	assert("contents indentical to system", memcmp(dummy_str1, dummy_str2, STR_NORMAL_LEN + 1), 0);
	...
	memmove(dummy_str1, dummy_str1 + 1, STR_NORMAL_LEN - 1);
	assert("contents indentical to system", memcmp(dummy_str1, dummy_str2, STR_NORMAL_LEN - 1), 0);
